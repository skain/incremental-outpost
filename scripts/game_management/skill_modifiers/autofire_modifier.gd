class_name AutofireModifier extends ModifierBase
...
func _init(outpost_arm: Enums.OutpostArms) -> void:
	match outpost_arm:
		Enums.OutpostArms.TOP:
			affected_stat = SkillTreeNode.AffectedStat.AUTOFIRE_TOP
		Enums.OutpostArms.RIGHT:
			affected_stat = SkillTreeNode.AffectedStat.AUTOFIRE_RIGHT
		Enums.OutpostArms.BOTTOM:
			affected_stat = SkillTreeNode.AffectedStat.AUTOFIRE_BOTTOM
		Enums.OutpostArms.LEFT:
			affected_stat = SkillTreeNode.AffectedStat.AUTOFIRE_LEFT
